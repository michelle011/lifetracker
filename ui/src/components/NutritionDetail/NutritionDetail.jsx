        ...
        <div className="nutrition-detail">
            {props.nutrition.map((element, idx) => {
                if(element.id == nutritionId){
                    ...
                    return <NutritionCard key={idx} quantity={element.quantity} imageUrl={element.image_url} name={element.name} calories={element.calories} category={element.category} createdAt={element.created_at} id={element.id}></NutritionCard>
                }
            })}
        </div>
    )
