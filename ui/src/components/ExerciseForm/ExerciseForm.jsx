...
export default function ExerciseForm(props){
    ...
    const handleOnSubmit = async (e) => {
        e.preventDefault()
        setIsLoading(true)
        const { data , error} = await apiClient.createExercise({name: form.name, category: form.category, duration: form.duration, intensity: form.intensity})
        if(error){
            setErrors(error)
        }
        if(data){
                ...
                <div className="inputs">
                    ...
                    <div className="split-form-input">
                        <div className="form-input">
                            ...
                            <input type="number" name="duration" min="1" max="10000000" value={form.duration} onChange={handleOnInputChange}/>
